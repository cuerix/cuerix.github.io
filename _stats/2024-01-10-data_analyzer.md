...
<center>
<div style="border: 1px solid grey; width: fit-content;">
  <img width="800" alt="image" src="https://github.com/user-attachments/assets/dc23869b-4c06-4be0-9872-4a482cc0352a">
</div>
</center>

#### ✔️ 변수 설정 방법 
     ① 분석할 연속형 변수(열)을 선택합니다.
      ② 변수 종류에 따른 분석방법을 선택합니다.
      ③ 데이터 분석 아이콘을 클릭하여 분석 결과를 확인합니다.
...
<center>
<div style="border: 1px solid grey; width: fit-content;">
  <img width="800" alt="image" src="https://github.com/user-attachments/assets/5f9136b7-ec80-4a72-9e9b-46c1df70a819">
</div>
</center>
...
<center>
<div style="border: 1px solid grey; width: fit-content;">
  <img width="800" alt="image" src="https://github.com/user-attachments/assets/1cd546c3-63df-4fb4-8bf2-d667961560e7"](https://github.com/user-attachments/assets/e0221ca4-cc68-45dc-97ff-6dd11e3254e6>
</div>
</center>
...
##### 다중 회귀  
      ① 종속변수에 해당하는 연속형 변수(열)을 선택합니다.  
      ② 독립변수에 해당하는 연속형 변수(열)을 선택합니다.  
      ③ 변수추가 아이콘을 클릭하여 독립변수를 추가합니다.  
      ③ 다중회귀 변수추가 아이콘을 클릭하여 독립변수를 추가합니다.  
      ④ 데이터 분석 아이콘을 클릭하여 분석 결과를 확인합니다.  
