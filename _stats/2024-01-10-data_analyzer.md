...
만약 그룹 간 분산이 동일하지 않다면, 일부 분석 결과가 왜곡될 수 있으므로 비모수적 방법을 고려하거나 데이터를 변환해야 할 수 있습니다.<br>

### 검정 종류
대표적인 등분산 검정 방법 두 가지는 다음과 같습니다.<br>
...
- <strong>르빈 검정(Levene Test)</strong><br>
  ...
  이는 분산이 정규분포를 따르지 않는 경우에도 적용할 수 있는 검정입니다.<br>
