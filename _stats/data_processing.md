...
<div style="border: 1px solid #1DA1F2; padding: 15px; border-radius: 5px; background-color: #E8F5FD; color: #333;">
       <strong> ℹ️</strong> 사용자는 등간 척도 등 점수 척도가 필요한 경우, 반드시 <strong>[기본규칙 가져오기]</strong>를 통해 전처리 기본규칙을 생성한 후, 설문지를 디자인해야 합니다. 기본규칙 외에 별도의 점수 척도 변환이 필요한 경우, 해당 척도를 척도 셋에 등록한 후 설문지를 디자인하십시오.    
...
<details>
  ...
  <div class="item">
    ...
    <span class="item-title">데이터 전처리 기본규칙 가져오기</span><br>
...
<details>
  ...
  <div class="item">
    <div class="item-content">
     ...
     ④ 설정이 끝났으면 <strong>등록</strong>을 클릭합니다.<br>
 </details>
...
<details>
  ...
  <div class="item">
    <div class="item-content">
    <span class="item-title">결측지 처리</span><br>
    새로운 규칙을 등록합니다. <br><br>
    <span class="item-title">셋(set) 추가</span><br>
     동기화 기능입니다.
