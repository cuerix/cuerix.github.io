...
|🎨 Survey Canvas |(설문지 디자인 상태) 설문지 디자인을 완료해 설문조사를 시작할 수 있는 상태입니다. Complete 상태 표시는 설문지 이름을 클릭하고 나타난 상세보기에서 사용자가 직접 상태 표시를 Complete로 변경해야 합니다.  |
